...
def main():
    ...
    # [FIX] Create a specific subfolder for this video to avoid overwriting reports
    # naming convention: {video_filename_without_extension}_qc_report
    ...
    for category, module in VALIDATORS:
        res = run_validator(category, module, input_video, outdir, args.mode)
        results.append(res)
